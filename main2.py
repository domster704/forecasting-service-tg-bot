...
from steps.login import loginRouter, CheckAuthorizationMiddleware
...
if __name__ == "__main__":
    loginRouter.message.middleware(CheckAuthorizationMiddleware(session=session))
    dp.include_router(loginRouter)
