...
class User(Base):
    ...
    # purchases = Column("purchases", MutableDict.as_mutable(JSON))
    purchases = Column(JSON, index=True)
    ...
    def putProduct(self, json: dict[str, str], purchaseId: str):
        ...
        # localJson = self.purchases[purchaseId]['rows'].copy()
        # localJson.append(json)
